...
import "../emailopen/emailopen.css";
...
import Minus from "../../../assets/images/email-compose/Remove.svg";
import Cross from "../../../assets/images/email-compose/Close.svg";
import Bold from "../../../assets/images/email-compose/Bold.svg";
import Italic from "../../../assets/images/email-compose/Italic.svg";
import Underline from "../../../assets/images/email-compose/underline.svg";
import First from "../../../assets/images/email-compose/first.svg";
import Second from "../../../assets/images/email-compose/second.svg";
import Third from "../../../assets/images/email-compose/third.svg";
import Fourth from "../../../assets/images/email-compose/fourth.svg";
import Fifth from "../../../assets/images/email-compose/fifth.svg";
import Button from "../../../assets/images/email-compose/button.svg";
        ...
        <div className="flex flex-row justify-between bg-white">
          ...
          <div className="w-9/12  flex flex-col  second-section">
            ...
            <div className="second-box">
              ...
              <div className="inner-box relative flex justify-center">
                <div
              ...
              <div
                className="absolute bg-white border border-gray-200 rounded-lg shadow
                dark:bg-gray-700 dark:border-gray-700 mt-7  text-sm text-gray-500 absolute-box"
              >
                <div className="header-mail flex ">
                  <p className="text-gray-600 ml-5 mt-2">Compose Mail</p>
                  <Image src={Minus} alt={""} className="ml-auto" />
                  <Image src={Cross} alt={""} className="mr-5 ml-3" />
                </div>
                <hr />
                <div className="to mt-3 flex ml-5">
                  <p className="text-gray">To:</p>
                  <p className="ml-auto mr-6">Cc | Bcc</p>
                </div>
                <hr />
                <div className="from mt-3 ml-5">
                  <p className="text-gray">Subject:</p>
                </div>
                <hr />
                <div className="icons flex mt-3 ml-5">
                  <Image src={Bold} alt={""} />
                  <Image src={Italic} alt={""} className="ml-3" />
                  <Image src={Underline} alt={""} className="ml-3" />
                  <Image src={First} alt={""} className="ml-3" />
                  <Image src={Second} alt={""} className="ml-3" />
                  <Image src={Third} alt={""} className="ml-3" />
                  <Image src={Fourth} alt={""} className="ml-3" />
                  <Image src={Fifth} alt={""} className="ml-3" />
                </div>
                <hr />
                <p className="mt-3 ml-5">Message</p>
                <hr className="mt-20" />
                <div className="send-button flex mt-3 ml-5 mb-2">
                  <button>SEND</button>
                  <Image src={Button} alt={""} />
                  <Image src={More} alt={""} className="ml-auto w-5" />
                  <Image src={Delete} alt={""} className="mr-5 ml-3 w-5" />
                </div>
              </div>
            </div>
          </div>
